import numpy as np
loss = np.load("cifar_pmphmc_loss.npy")
train_acc = np.load("cifar_pmphmc_train_acc.npy")*100
test_acc = np.load("cifar_pmphmc_test_acc.npy")*100
