import numpy as np
loss = np.load("cifar_mhhmc_loss.npy")
train_acc = np.load("cifar_mhhmc_train_acc.npy")*100
test_acc = np.load("cifar_mhhmc_test_acc.npy")*100
import matplotlib.pyplot as plt

sample_num = loss.shape[0]
line_loss = np.linspace(0,sample_num,sample_num)
